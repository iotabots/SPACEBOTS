...
const ct = {
     ...
     */
    version: '1.7.0',
    meta: [{"name":"SPACEBOTS","author":"iotaben","site":"iotabots.io","version":"0.0.0"}][0],
    main: {
        fpstick: 0,
        pi: 0
    },
...
ct.rooms.templates['Main'] = {
    ...
    objects: JSON.parse('[{"x":70,"y":152,"exts":{},"type":"PlayerShip"}]'),
    bgs: JSON.parse('[{"depth":-5,"extends":{},"texture":"BG"}]'),
    tiles: JSON.parse('[{"depth":-10,"tiles":[],"extends":{}}]'),
    backgroundColor: '#000000',
    cameraConstraints: {"x1":0,"y1":0,"x2":160,"y2":144},
    onStep() {
        this.asteroidTimer -= ct.delta;
if (this.asteroidTimer <= 0) {
    this.asteroidTimer = ct.random.range(20, 100);
    ct.types.copy(ct.random.dice('Asteroid_Big', 'Asteroid_Medium'), ct.random(ct.viewWidth), -50);
}

this.enemyTimer -= ct.delta;
if (this.enemyTimer <= 0) {
    this.enemyTimer = ct.random.range(60, 200);
    ct.types.copy('EnemyShip', ct.random(ct.viewWidth), -50);
}
    },
    onDraw() {
...
ct.rooms.templates['MainMenu'] = {
    ...
    height: 144,
    /* JSON.parse allows for a much faster loading of big objects */
    objects: JSON.parse('[{"x":80,"y":72,"exts":{},"type":"Start_Screen"}]'),
    bgs: JSON.parse('[{"depth":-5,"texture":"BG","extends":{}}]'),
    tiles: JSON.parse('[{"depth":-10,"tiles":[],"extends":{}}]'),
    backgroundColor: '#000000',
    cameraConstraints: {"x1":0,"y1":0,"x2":160,"y2":144},
    onStep() {
...
ct.styles.new(
    "ScoreText",
    {
    "fontFamily": "\"CTPROJFONTEarly GameBoy\", \"Early GameBoy\", sans-serif",
    "fontSize": 8,
    "fontStyle": "normal",
    "fontWeight": 400,
    "align": "left",
...
(function resAddon(ct) {
    ...
    ct.res = {
        ...
        soundsError: 0,
        sounds: {},
        registry: [{"PlayerShip":{"frames":1,"shape":{"type":"rect","top":29,"bottom":0,"left":11,"right":12},"anchor":{"x":0.4782608695652174,"y":1}},"LaserRed":{"frames":1,"shape":{"type":"rect","top":7,"bottom":7,"left":4,"right":5},"anchor":{"x":0.4444444444444444,"y":0.5}},"Laser_Blue":{"frames":1,"shape":{"type":"rect","top":6,"bottom":7,"left":2,"right":3},"anchor":{"x":0.4,"y":0.46153846153846156}},"EnemyShip":{"frames":1,"shape":{"type":"rect","top":20,"bottom":20,"left":18,"right":18},"anchor":{"x":0.5,"y":0.5}},"Asteroid_Medium":{"frames":1,"shape":{"type":"rect","top":5,"bottom":6,"left":5,"right":5},"anchor":{"x":0.5,"y":0.45454545454545453}},"Asteroid_Big":{"frames":1,"shape":{"type":"rect","top":14,"bottom":14,"left":14,"right":14},"anchor":{"x":0.5,"y":0.5}},"BG":{"atlas":"./img/t0.png","frames":0,"shape":{"type":"rect","top":0,"bottom":144,"left":0,"right":160},"anchor":{"x":0,"y":0}},"Start_Screen":{"atlas":"./img/t1.png","frames":0,"shape":{"type":"rect","top":72,"bottom":72,"left":80,"right":80},"anchor":{"x":0.5,"y":0.5}},"favicon-32x32":{"frames":1,"shape":{"type":"rect","top":0,"bottom":32,"left":0,"right":32},"anchor":{"x":0,"y":0}}}][0],
...
this.x += 2 * ct.delta * ct.actions.MoveX.value; // Move by X axis
...
if (ct.actions.Shoot.pressed) {
    ct.types.copy('Laser_Blue', this.x, this.y -30);
}
...
if (hostile) {
    ...
    if (ct.room.lives <= 0) {
        this.kill = true;
        setTimeout(function() {
            alert("Game Over! Play again :-) Score: " + ct.room.score)
            location.reload();
...
ct.types.list['Laser_Red'] = [];
ct.types.templates["Laser_Blue"] = {
    depth: 0,
    texture: "Laser_Blue",
    onStep: function () {
        if (this.y < -40) {
...
ct.types.move(this);
    ...
    onCreate: function () {
        ct.sound.spawn('laser_bot');
this.speed = 3;
this.direction = 90;
    },
    extends: {}
};
ct.types.list['Laser_Blue'] = [];
...
if (this.bulletTimer <= 0) {
    ...
    ct.types.copy('Laser_Red', this.x, this.y);
}
    },
    onDraw: function () {
...
ct.types.templates["Asteroid_Medium"] = {
    depth: 0,
...
if (collided) {
    ...
    onDestroy: function () {
        ct.sound.spawn('explosion_astroid_small');
    },
    onCreate: function () {
        this.speed = ct.random.range(2, 3);
this.direction = ct.random.range(270 - 30, 270 + 30);
this.ctype = 'Hostile';
    },
    extends: {}
};
ct.types.list['Asteroid_Medium'] = [];
ct.types.templates["Asteroid_Big"] = {
    depth: 0,
...
if (collided) {
    ...
    onDestroy: function () {
        ct.sound.spawn('explosion_astroid');
    },
    onCreate: function () {
...
ct.types.list['Asteroid_Big'] = [];
ct.types.templates["Start_Screen"] = {
    depth: 0,
...
ct.sound.init('explosion_astroid', {
    wav: './snd/8b53af8b-eab8-4bb2-bb2e-8d5c8dcdd2cc.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('explosion_ship', {
    wav: './snd/9c2c754a-66fd-46a4-9be3-a201c81f2d83.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('explosion_astroid_small', {
    wav: './snd/ed67f1e2-be7d-432d-88ba-1bd1932dfaf1.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('laser_bot', {
    wav: './snd/2c16dc9f-c07b-4dbe-885f-1f32c0853533.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('death', {
    wav: './snd/bfec2968-2a56-47d0-91af-8ec26820cda4.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('laser_enemy', {
    wav: './snd/7a3dd9b9-9995-4a14-b238-3e82d05d4059.wav',
    mp3: false,
    ogg: false
}, {
    poolSize: 5,
...
ct.sound.init('song', {
    wav: false,
    mp3: './snd/716c7bbc-68eb-4485-a758-e12303c052b8.mp3',
    ogg: false
}, {
    poolSize: 5,
    music: true
